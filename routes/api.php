...
use App\Http\Controllers\MedicineAssignController;
use App\Http\Controllers\ItemQuantityAdjustmentController;
...
Route::middleware(['web', 'auth:sanctum'])->group(function () {
    ...
    Route::prefix('items')->group(function () {
        ...
        Route::get('/available/medicine', [DailyInventoryController::class, 'getAvailableOpenStockItems']); //get list of medicines that is available
        Route::get('/adjustment/{item_id}', [ItemQuantityAdjustmentController::class, 'getItemInformation']);
    });
    ...
    Route::prefix('system')->group(function () {
        ...
        Route::get('/user/assigned', [MedicineAssignController::class, 'ShowAssignedMedicine']);
        Route::post('/user/assign/remove', [MedicineAssignController::class, 'RemoveAssignedMedicine']);
        Route::get('/user/assigned/exist', [MedicineAssignController::class, 'medicineAssignedExist']);
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::post('/dispense/recipient', [ReportsController::class, 'Recipients_Report']);          // get dispense recipient report
    ...
    Route::prefix('maif')->group(function () {
        ...
        Route::get('/patients/medication', [MaifController::class, 'get_patients_medication']); // Fetch patients for medication
        Route::get('/patients/laboratory', [MaifController::class, 'get_patients_laboratory']); // Fetch patients for laboratory
